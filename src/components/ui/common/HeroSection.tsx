...
const HeroSection = () => {
  ...
  return (
    <section className="mb-40 overflow-hidden">
      <div
        className="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] h-[100vh]"
        style={sectionStyle}
      >
          ...
          <div className="flex h-full items-center justify-center">
            <div className="px-6 text-center text-white md:px-12">
              <h1 className="mt-6 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl">
                ...
                <span className="text-2xl font-bold tracking-tight md:text-3xl xl:text-4xl">
                  Discover, Wishlist, and Dive into Reading
                </span>
              </h1>
              <Link
